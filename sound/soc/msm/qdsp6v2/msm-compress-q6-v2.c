					     ...
					     bool use_gapless_codec_options)
{
	...
	case FORMAT_VORBIS:
		...
		cfg = codec_options->vorbis_dec.bit_stream_fmt;
	...
	case FORMAT_ALAC:
		...
		alac_cfg.max_frame_bytes =
			codec_options->alac.max_frame_bytes;
		alac_cfg.avg_bit_rate =
			codec_options->alac.avg_bit_rate;
